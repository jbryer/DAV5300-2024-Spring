year <- 2024
semester <- 'Spring'
github_link <- "DAV5300Spring2024"
one_minute_paper <- 'https://forms.gle/CD5Qxkq3xtdxSheW8'
one_minute_paper_results <- "https://docs.google.com/spreadsheets/d/1C-G3wD1gLzBPNDCL2bPEpn8J0wpgfN_pkn2JksiHal4/edit?resourcekey#gid=1731493110"
formative_assessment <- 'https://forms.gle/Z9pKeuXVqoo6AwLS9'
formative_assessmnet_results <- 'https://docs.google.com/spreadsheets/d/1hw5fxvTNYi8lt2JnyXPSOiWSpN0MKcji5nuC7THN2qM/edit?resourcekey#gid=465598735'
slack_invite_link <- ''
